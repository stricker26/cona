                        ...
                        <li class="dropdown-submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @foreach($provinces as $province)
                                    ...
                                    <a data-value="{{$province->province_code}},{{$province->type}}" class="d-inline"><i class="far fa-map align-top pt-2"></i><div class="d-inline-block pl-3 prov-part">{{ ucwords(strtolower($province->lgu)) }}</div></a>
                                    @endif
                                @endforeach
                                </li>
                            </ul>
