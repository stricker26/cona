	...
	<div class="col-sm-12 text-center">
		...
		<div class="pt-3">
		 	...
		 	@if(ucwords($getregion[0]) == 'Region')
				<a href="{{ url()->current() . '/export/0/region/' . $getregion[1] }}" class="btn btn-primary" target="_blank">Download CONA By Region
				</a>
			@elseif(ucwords($getregion[0]) == 'All')
				<a href="{{ url()->current() . '/export/0/0/all' }}" class="btn btn-primary" target="_blank">Download All CONA</a>
			@else
		 		<a href="{{ url()->current() . '/export/0/province/' . $candidates[0]->province_id }}" class="btn btn-primary" target="_blank">Download CONA By Province</a>
		 	@endif
